...
## Data Loading
The dataset used in this project is the Iris dataset, obtained from https://archive.ics.uci.edu/dataset/53/iris. We use pandas to read the csv from the link, and create a dataframe with column names ["sepal_length","sepal_width","petal_length","petal_width","class"]
